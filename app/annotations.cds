using { frostYuan_STUDENTG30Srv } from '../srv/service.cds';

annotate frostYuan_STUDENTG30Srv.CustomerMessage with @UI.HeaderInfo: { TypeName: 'Customer Message', TypeNamePlural: 'Customer Messages', Title: { Value: customerMessageID } };
annotate frostYuan_STUDENTG30Srv.CustomerMessage with {
  ID @UI.Hidden @Common.Text: { $value: customerMessageID, ![@UI.TextArrangement]: #TextOnly }
};
annotate frostYuan_STUDENTG30Srv.CustomerMessage with @UI.Identification: [{ Value: customerMessageID }];
annotate frostYuan_STUDENTG30Srv.CustomerMessage with {
...
annotate frostYuan_STUDENTG30Srv.CustomerMessage with @UI.LineItem: [
...
annotate frostYuan_STUDENTG30Srv.CustomerMessage with @UI.FieldGroup #Main: {
...
annotate frostYuan_STUDENTG30Srv.CustomerMessage with @UI.Facets: [
  { $Type: 'UI.ReferenceFacet', ID: 'Main', Label: 'General Information', Target: '@UI.FieldGroup#Main' }
];

annotate frostYuan_STUDENTG30Srv.CustomerMessage with @UI.SelectionFields: [
  customerMessageID
];
